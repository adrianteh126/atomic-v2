<template>
  ...
  <!-- Header utility button at right -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer d-flex justify-content-between">
            ...
            <div id="button-container">
              ...
              <button type="button" id="modalDeleteBtn" @click="deleteAndClose(state.EditT_id)" class="btn btn-danger ms-2">Delete Task</button>
            </div>
          </div>
        </div>
      </div>
...
app2.mount('#app2');
  ...
  export default {
    ...
    methods: {
      ...
      saveEditAndClose() {
        this.editTodo(); // Call the editTodo method with the _id parameter
        this.saveEditChanges(); // Call the saveChanges method
        $('#modal_edit').modal('hide');
      },
          deleteAndClose(_id) {
            this.deleteTodo(_id); // Call the newTodo method
            this.saveChanges(); // Call the saveChanges method
            $('#modal_edit').modal('hide'); // Call the closeModal method
          },
      // Add crud:
      openModalAdd() {
